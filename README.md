...
2. If you want to adsjust learning rate on-the-fly, create `lr.txt` having only contents with lr value in same directory with main.py. And just change the value before some epoch.
